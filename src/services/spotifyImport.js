...
/**
 * Match a list of Spotify tracks against Music API and return the matched playable songs.
 ...
 * @returns {Promise<Array<Object>>} The array of matched song objects.
 */
export async function matchTracksToApi(spotifyTracks, onProgress) {
  const matchedSongs = [];
